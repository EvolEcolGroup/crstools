...
#'   "moll" (Mollweide), "hammer" (Hammer),
#'   "eck4" (Eckert IV), "wag4" (Wagner IV),
#'   "wag7" (Wagner VII), "tpeqd" (Two Point Equidistant), "robin" (Robinson),
#'   "natearth" (Natural Earth), "wintri" (Winkel Tripel),
#'   "patterson" (Patterson), "latlong" (Latitude/Longitude),
#'   "mill" (Miller Cylindrical), "tmerc" (Transverse
