test_that("test whole world", {
 ...
 UNIT["Meter",1.0]]'
  ...
  expect_error(
    whole_equidist <- suggest_crs(c(-180, 180, -90, 90), distortion = "equidistant"),
    "`world_equidist` must be provided for equidistant world map projections"
  )
  expect_error(
    whole_equidist <- suggest_crs(c(-180, 180, -90, 90),
  ...
  expect_error(
    whole_equidist <- two_points_equidist <- suggest_crs(c(-180, 180, -90, 90),
      distortion = "equidistant",
      world_equidist = list(
        prj = "two_points",
        lng1 = -117,
 ...
 UNIT["Meter",1.0]]'
  ...
  # COMPROMISE
  expect_message(
    whole_comp_list <- suggest_crs(c(-180, 180, -90, 90),
  ...
  # CONFORMAL
  expect_error(
    whole_conf <- suggest_crs(c(-180, 180, -90, 90), distortion = "conformal"),
