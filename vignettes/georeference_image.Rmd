...
![Figure: GCPs selected on the map by clicking with the mouse](img/europe_image_georef1.png){width=500px}
...
![Figure: Window opened by `find_gcp_coords()`](./img/europe_image_GCP.png){width=500px}
